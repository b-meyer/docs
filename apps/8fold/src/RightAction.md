---
title: 'Right Action - Ethical Deeds'
description: 'Right Action - the practice of non-harming, honesty, and sexual integrity as a foundation for mental peace.'
---

# Right Action - Samma Kammanta

Right Action is the practice of ethical integrity through our physical deeds. While **Right Speech** cleanses our communication, Right Action prevents suffering from our physical presence. In the Buddhist framework, these are **training rules** (_Sikkhapada_) that protect the practitioner from the agitation of guilt and the friction of social conflict.
...
- **Environmental Theft** - Taking more than one's "fair share" of finite resources (water, clean air, biodiversity). This effectively steals from future generations.
- **In Practice** - Cultivate a "mind of abundance" that is content with what it has and looks for opportunities to share.

---

## 3. Sexual Integrity (_Kamesu Micchacara_)
...
In a modern primer, this fold is often viewed as the ethical management of **Sexual Energy** (_Jing/Tinh_).

- **The Principle** - Sexuality is a creative force. If used casually, lovelessy, or deceptively, it dissipates mental energy and causes emotional harm.
- **Integrity** - Use sexual energy to build trust and deep connection rather than to consume or objectify another.
- **In Practice** - Ensure all interactions are based on mutual consent, honesty, and a respect for the dignity of everyone involved. Loneliness is solved through the heart, not just the body.

---

## The Moral Weight of an Action

Not all harmful actions carry the same weight. The Buddhist analysis identifies three variables that determine the _kammic_ impact of an action:
...
Right Action is not about being "good" in a moralistic sense; it is about being **Skillful** (_Kusala_), acting in a way that leads toward peace and away from suffering.

---

**Next Fold:**

- **[RightLivelihood.md](RightLivelihood.md)** - Integrating ethics into our work.
