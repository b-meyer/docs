...
Mundane Right View provides the moral framework for a harmonious life. It is the understanding that our actions have consequences — the law of **Kamma**. Specifically, it is the "right view of the ownership of action" (_kammassakatā sammādiṭṭhi_)—the recognition that **beings are the heirs of their actions**. This view acknowledges that good and bad actions produce corresponding results, that moral efficacy is real and objective, and that this principle extends across lifetimes.
...
- **Ultimate Truth** (_Paramattha-sacca_): In reality, there is no abiding, permanent entity — only a flux of changing physical and mental energies arising in dependence on conditions. The "self" is a designation applied to a process, not a thing.
