---
title: 'The Dao'
description: 'The Way: the ineffable source and pattern underlying all reality, from which all things arise and to which they return.'
---
...
The [Daodejing](Daodejing.md) opens with a warning that "The Dao that can be spoken is not the constant Dao." Whatever words point toward, the Dao exceeds it. [Laozi](Laozi.md) uses "Dao" as a provisional label for something that has no proper name, describing it as formless, soundless, and impossible to grasp.
...
The Daodejing gives a compressed account of how reality arises from the Dao. The Dao generates one, one generates two, two generates three, and three generates the ten thousand things. There is no craftsman, no command, no moment of making from nothing. The ten thousand things emerge from the Dao the way mist rises from water, without separation from the source.

[Cosmogony](Cosmogony.md) in Daoist thought is return as much as emergence. The ten thousand things arise from the Dao and eventually return to it. The Dao is prior to heaven and earth, the "mother of all things," and things that deviate from it exhaust themselves and come back.
