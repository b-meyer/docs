---
title: 'A History of Daoism'
description: 'Warring States origins through Han statecraft, the medieval schools, and into the modern revival in China, Taiwan, and beyond.'
---
...
```mermaid
graph LR
    A["Warring States\n(5th-3rd c. BCE)\nClassical texts"] --> B["Han Dynasty\n(206 BCE-220 CE)\nHuang-Lao, Celestial Masters"]
    B --> C["Wei-Jin\n(3rd-4th c. CE)\nXuanxue"]
    C --> D["Medieval Period\n(4th-6th c. CE)\nShangqing, Lingbao"]
    D --> E["Tang Dynasty\n(618-907 CE)\nState Patronage"]
    E --> F["Song-Ming\n(960-1644 CE)\nQuanzhen, Zhengyi"]
