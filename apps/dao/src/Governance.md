---
title: 'Governing by Wu Wei'
description: 'How the Daodejing applies wu wei to rulership, arguing that a ruler who abandons self-serving desire allows the people to transform themselves.'
---

# Governing by Wu Wei

The [Daodejing](Daodejing.md) treats governance as a problem of restraint rather than a problem of policy. The ruler who enacts [wu wei](WuWei.md) does not withdraw from power but abandons the drive to shape outcomes through force, hierarchy, or incentive. The result, the text argues, is that people order themselves without coercion.
