...
description: 'Dietary therapy (食療 - Shí Liáo) - the fourth branch of TCM treatment. Foods profiled by temperature, flavor, channel, and action; prescribed by constitution and pattern from the Five Flavors through postpartum confinement to seasonal alignment.'
---
...
Hu Sihui's _Yin Shan Zheng Yao_ (飲膳正要, Yuan dynasty, 1330 CE) was an imperial nutrition manual commissioned for the Mongol court and the first text to document seasonal eating protocols extensively and to connect ingredient quality (provenance, freshness, preparation) to therapeutic efficacy. Li Shizhen's _Ben Cao Gang Mu_ (本草綱目, Ming dynasty, 1578 CE) classifies hundreds of ordinary kitchen foods, including grains, vegetables, fruits, meats, and fish. Each is profiled with temperature, flavor, channel affinity, and clinical application; its food sections are the most consulted dietary therapy reference in modern TCM education.
...
Warm and Cool are the working categories for most healthy people. Hot and Cold are used therapeutically and with caution. Sustained Hot food intake produces interior Heat, and sustained Cold intake damages Spleen and Stomach Yang and generates Damp accumulation (see [JinYe.md](JinYe.md)). Neutral foods form the backbone of any constitutional diet; the therapeutic pivot is adding Warm or Cool foods at the margins.
...
Beyond temperature and flavor, each food is profiled by **channel affinity** (_guī jīng_, 歸經), indicating which [organ system](ZangFu.md) it primarily enters, and by its **functional action**:
...
- **Tonify Yang:** Lamb (_yáng ròu_), walnut (_hé táo rén_), black bean, garlic, leek, cinnamon, dried ginger, deer antler velvet. Warm to Hot; support Kidney Yang, which is the root fire of the entire system.
...
- **Invigorate Blood:** Turmeric, hawthorn (_shān zhā_), vinegar, rose petals, crab (Cold natured; use with caution), black fungus (_mù ěr_). Overlap with Qi-moving foods is significant because Qi is the commander of Blood.
- **Transform Damp / resolve Phlegm:** Job's tears (_yì yǐ rén_), adzuki bean, winter melon, barley (_dà mài_), Fu Ling (_poria_), tangerine peel, turnip, radish, seaweed (Cold; use with care). Dietary counterpart to Damp-resolving herbal formulas.
...
- **Calm [Shen](Shen.md):** Lotus seed, lily bulb, longan, jujube, mulberry, wheat (_fú xiāo mài_, floating wheat, used specifically for night sweats and Heart deficiency). Overlap with Blood-tonifying foods is substantial because Shen is housed in the Blood.
...
- **Boiling and simmering** shift thermal character slightly toward Neutral. Long-simmered congee breaks down cell walls and pre-digests starch, sharply reducing the Spleen's workload. This is why congee is the canonical food for illness recovery and Spleen deficiency.
...
- **Deep-frying** makes any ingredient more Heating and more Damp-producing, creating a double liability for chronic pattern management.
...
- **Long bone broth** is Yin- and Marrow-tonifying. Long simmering (12–24 hours) extracts the deepest nutritive essence, functioning as a kitchen analog to Kidney-tonifying herbs that replenish [Jing](Jing.md) and Marrow.
...
**Spleen Qi deficiency** is the pattern most directly created and corrected by diet. Signs: fatigue after eating, bloating, loose stool, poor appetite, heavy limbs, pale complexion. _Eat:_ warm cooked food; congee with Chinese yam and lotus seed; chicken, beef, dates, oats. _Avoid:_ raw salads, iced drinks, dairy, sugar, excess fruit, cold leftovers. See [Spleen.md](Spleen.md).

**Yin deficiency** presents as afternoon Heat, night sweats, dry mouth and throat, thin body, flushed cheeks, and restless sleep. _Eat:_ pear congee, lily bulb soup, black sesame paste, tofu, duck, tremella mushroom jelly, honey water. _Avoid:_ pungent/spicy foods, coffee, alcohol, excess lamb or ginger.

**Yang deficiency** presents as cold limbs, low libido, pale complexion, abundant clear urine, lower back cold and aching, and fatigue worse in cold weather. _Eat:_ lamb stew with ginger and astragalus, walnut congee, garlic, leek, dried ginger tea. _Avoid:_ cold raw foods, iced drinks, excess bitter foods, watermelon.

**Damp accumulation** presents as heaviness, foggy thinking, sticky tongue coat, loose stool, weight gain, and bloating. _Eat:_ Job's tears porridge, adzuki bean soup, winter melon, barley water. _Avoid:_ dairy, sugar, greasy/fried foods, alcohol, excess sweet fruit. Even Warm-natured Sweet foods (dates, longan) are restricted until Damp clears.

**Liver Qi stagnation** presents as distending flank pain, mood dysregulation, premenstrual tension, sighing, and tight neck and shoulders. _Eat:_ rose petal tea, citrus peel, small amounts of vinegar, lightly pungent and sour foods in rotation. _Avoid:_ excess greasy, rich, or alcohol. See [Liver.md](Liver.md).

**Heat patterns** (Stomach Heat, Liver Fire, Yin deficiency Heat) present as thirst, red face, yellow tongue coat, irritability, dark urine, and constipation. _Eat:_ mung bean soup, cucumber, watermelon (Cold thermally but served at room temperature, not iced), bitter melon, and chrysanthemum tea. _Avoid:_ spicy, fried, alcohol, lamb, coffee.

```mermaid
flowchart TD
    A[Si Zhen: Four Examinations] --> B[Ba Gang: Eight Principle Pattern]
    B --> C{Temperature?}
    C -->|Cold / Yang deficient| D[Warm & Hot foods\nLamb · Ginger · Leek · Walnut]
    C -->|Heat / Yin deficient| E[Cool & moistening foods\nPear · Tofu · Mung bean · Tremella]
    C -->|Neutral / mixed| F[Neutral base + targeted modifiers]
    B --> G{Excess or Deficiency?}
    G -->|Deficiency| H[Tonify: Congee, Bone broth,\nDates, Goji, Black sesame]
    G -->|Excess Damp/Phlegm| I[Drain: Job's tears, Adzuki,\nWinter melon, Barley]
    G -->|Excess Qi stagnation| J[Move: Citrus peel, Rose,\nHawthorn, Radish]
```
...
- **Summer (Fire / Heart):** Slight cooling via mung bean soup, cucumber, watermelon rind, and bitter melon, served warm rather than iced. Bitter foods support the [Heart](Heart.md). Avoid excess cold drinks and raw fruit, which damage Spleen Yang and generate post-summer Damp.
...
- **Winter (Water / Kidney):** Maximum Yin; storing season. Black foods (black bean, black sesame, black fungus, Kidney-aligned by color), bone broth, walnut, and lamb stew with goji and ginger. Winter is the season for rebuilding [Jing](Jing.md), the reserve governing aging, fertility, and constitutional resilience.

**Circadian alignment:** The Stomach organ clock runs 7–9 AM and Spleen 9–11 AM, representing peak digestive capacity. Classical guidance: eat the largest, most nutritive meal in the morning or at midday at latest. Light, early dinners and a gap before sleep are the most consistently emphasized behavioral recommendations across the classical dietary texts, and align with modern chrono-nutrition research.

## Canonical therapeutic applications

**Medicinal congees (_yào zhōu_, 藥粥).** Congee (_zhōu_), long-simmered rice, serves as the universal Spleen-supporting base. Additional ingredients shift the indication:
