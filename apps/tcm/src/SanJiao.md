---
title: 'San Jiao (Triple Burner)'
description: 'San Jiao (Triple Burner) - the invisible thermal and fluid pathway through Upper, Middle, and Lower body cavities. It has no Western anatomical counterpart.'
---
...
When San Jiao Qi is generally blocked (neither heat nor cold, but simple obstruction), fluids fail to transform and move at any level. Presentation is systemic: generalized puffiness and heaviness, reduced urination without burning quality, bloating, fatigue, and a swollen pale tongue with a white greasy coat. This is the pattern most directly linked to chronic water metabolism failure. It maps onto the _Wu Ling San_ framework, which addresses fluid stagnation across the burners while supporting Yang transformation.
...
```mermaid
graph LR
  A[Spleen / Kidney Yang deficiency] --> B[Middle / Lower Jiao<br/>transformation fails]
  B --> C[San Jiao waterways blocked]
  C --> D[Fluid accumulates in tissue<br/>edema, lymph stasis]
  D --> E[Damp obstructs Spleen further]
  E --> A
```
...
- **San Ren Tang** (Three Seed Decoction) - the foundational formula for Damp-Heat across all three jiaos, particularly when the Upper Jiao is the entry point (early-stage damp-warmth). Lightly opens the Upper Jiao, transforms Middle Jiao damp, and promotes Lower Jiao excretion simultaneously. This makes it uniquely suited to the San Jiao's triple-burner span.
- **Wu Ling San** (Five Ingredient Powder with Poria) - the canonical formula for fluid metabolism failure across the burners when the root is Yang deficiency and Qi transformation failure rather than Heat. Promotes urination, warms Yang, and opens fluid passages at all three levels. It is the prototype for most edema formulas.
- **Zhu Ling Tang** (Polyporus Decoction) - Lower Jiao damp-heat with Yin injury. It adds Yin-nourishing components to avoid drying out depleted fluid while clearing heat and draining water. Use this when Lower Jiao fluid blockage is complicated by heat damaging the residual Yin.
- **Gan Lu Xiao Du Dan** (Sweet Dew Special Pill to Eliminate Toxin) - a warm-disease formula for damp-heat obstructing all three jiaos. It is indicated when fever, jaundice, urinary dysfunction, and limb heaviness co-occur. It clears heat and resolves damp simultaneously from all three strata.
...
- **Moderate Exertion, Protect Sweat.** Sweating opens the exterior and moves fluid. However, excessive sweating or exercise in cold and damp conditions depletes Yang and invites external Damp-Cold into the channels.
...
From a TCM standpoint, a person with chronic fluid retention is not simply experiencing a plumbing problem. Their body's organizing intelligence has been disrupted. This is the San Jiao's capacity to coordinate the three burners into a coherent fluid and thermal economy. Restoring that coordination means working at every level: warming the root Yang so transformation restarts, clearing the pathways so accumulated Damp can drain, and nourishing the Spleen and Kidney so the conditions for reaccumulation do not persist. The San Jiao's apparent paradox, "a name but no form," is an organ that is everywhere and nowhere. It turns out to be a precise clinical insight: fluid disorders are network disorders, and a network requires a network-level intervention.
