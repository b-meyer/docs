...
A practitioner reads the patient's overall state in the first few seconds. The **Shen in the eyes** is the single highest-resolution diagnostic signal (see [Shen.md](Shen.md)):

- **Bright, alert, focused eyes** = strong Shen = good prognosis regardless of presenting illness.
- **Dull, clouded, vacant eyes** = disturbed or lost Shen = deeper disharmony than the symptoms suggest.
...
| Color         | Phase | Organ  | Pattern hint                      |
| ------------- | ----- | ------ | --------------------------------- |
| Green-blue    | Wood  | Liver  | Stagnation, pain, Wind            |
| Red           | Fire  | Heart  | Heat (full or empty)              |
| Yellow        | Earth | Spleen | Damp, Spleen deficiency, jaundice |
| White         | Metal | Lung   | Cold, Qi or Blood deficiency      |
| Black / dusky | Water | Kidney | Cold, Stasis, Kidney depletion    |

The _quality_ of the color matters as much as the hue: lustrous and bright suggests intact Qi; lusterless and dull suggests deeper depletion. A bright red face is Heat with strong Qi; a malar flush over a pale background is Yin-deficient empty Heat.

### Tongue diagnosis in depth

The tongue is one of two anchors of TCM diagnosis (the other being pulse). Its surface displays the state of the Qi, the depth shows the state of the Blood and Yin, and different zones map to different organs. The Heart projects onto the tip; Lung just behind; Spleen-Stomach center; Liver-Gallbladder sides; Kidney at the root.
...
- **Loud, forceful, abrupt** = Excess pattern.
- **Weak, soft, fading** = Deficiency.
- **Frequent sighing** = Liver Qi stagnation (one of the most reliable single signs).
- **Hoarse / weak voice** = Lung Qi deficiency.
- **Wheezing on exhalation** = Excess Phlegm; **wheezing on inhalation** = Kidney failing to grasp Qi (see [Qi.md](Qi.md)).
- **Frequent coughing** type matters: productive with thick yellow phlegm = Lung Heat; dry hacking = Lung Yin deficiency; productive with thin clear phlegm = Lung Cold.

**Body odors and excretion smells:**

- Strong, foul odor = Heat or Damp-Heat.
- Sour or rotten = Stomach Heat or Food Stagnation.
- Fishy = Cold or Damp.
...
| --- | ------------------------------------ | -------------------------------------------------------------- |
| 1   | Chills and fever                     | Exterior vs Interior, Cold vs Heat                             |
| 2   | Sweating                             | Wei Qi integrity, Yin status                                   |
| 3   | Head and body                        | Channel pathology, Wind, Qi-direction issues                   |
| 4   | Urination and stool                  | Lower-burner function, Damp, Cold, Heat                        |
| 5   | Appetite and thirst                  | Spleen-Stomach function, fluid status                          |
| 6   | Chest and abdomen                    | Liver Qi, Stagnation, Phlegm                                   |
| 7   | Deafness and tinnitus                | Kidney sufficiency                                             |
| 8   | Sleep                                | Heart, Liver, Shen                                             |
| 9   | Menstruation / reproductive          | Xue and Jing status (see [Xue.md](Xue.md), [Jing.md](Jing.md)) |
| 10  | Onset, prior illness, family history | Constitution, chronicity, trajectory                           |
...
| ------------------ | -------------------------------------- | ----------------------------------- |
| **Floating (fu)**  | Strong at surface, fades with pressure | Exterior pattern                    |
| **Sinking (chen)** | Only present at deep pressure          | Interior pattern                    |
| **Slow (chi)**     | <60 bpm                                | Cold                                |
| **Rapid (shu)**    | >90 bpm                                | Heat                                |
| **Wiry (xian)**    | Taut, like a guitar string             | Liver Qi stagnation, pain           |
| **Slippery (hua)** | Smooth, like beads sliding             | Damp, Phlegm, pregnancy             |
| **Choppy (se)**    | Hesitant, uneven                       | Xue Stasis or severe Xue deficiency |
| **Thin (xi)**      | Like a fine thread                     | Blood or Yin deficiency             |
| **Forceful (shi)** | Full and strong                        | Excess                              |
| **Empty (xu)**     | Weak, lacking substance                | Deficiency                          |

Specific pulse content also appears in [Xue.md](Xue.md) and [Qi.md](Qi.md).

### Abdominal palpation

A focused practitioner palpates the abdomen for tenderness, masses, distension, temperature, and tension:

- **Tenderness worsening with pressure** = Excess pattern at that site.
- **Tenderness relieved by pressure** = Deficiency.
- **Mass that moves** = Qi stagnation; **mass that is fixed** = Xue Stasis.
- **Cold to touch** = Yang deficiency at that region.

Abdominal patterns are particularly developed in the Japanese kanpo tradition.

## Synthesizing the four examinations
