...
description: 'A structured introduction to Traditional Chinese Medicine (Yin/Yang, Wu Xing, Qi, Zang-Fu organ systems, meridians, pathology, diagnostics, and daily practice).'
---
...
**Zang-Fu organ deep-dives.** One page exists for each channel-system organ; the [ZangFu.md](ZangFu.md) synthesis page is the launch point. They are grouped by Five Phases:
...
Without Jing there is no fuel; without Qi there is no fire; without Shen the fire is unwitnessed. Each feeds the others. Depleting one weakens the system; a skilled practitioner attends to all three.
