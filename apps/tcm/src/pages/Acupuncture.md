...
description: 'Acupuncture and moxibustion — history, acupoint categories, needle technique, moxibustion forms, point selection logic, major schools, specialized protocols, scientific evidence, and safety.'
---
...
The WHO estimates practice in over 180 countries. Among the five branches, acupuncture is the most thoroughly studied and the most contested — the one that translates most readily into a clinical trial framework.
...
Korea and Japan received the tradition through court exchanges by the 6th–7th centuries CE, diverging into distinct schools (see Major Schools). The French diplomat and physician **Georges Soulié de Morant** seeded European practice through early 20th-century texts. The pivotal moment for the English-speaking West was James Reston's **1971 _New York Times_ article** describing post-appendectomy pain management during Nixon's China visit — a single journalistic account that generated more American public interest than decades of prior academic literature.
...
The critical clinical event is **De Qi** (_dé qì_, 得氣 — "arrival of Qi"): heaviness, aching, distension, numbness, tingling, or channel-radiating sensation at the needled point. From the practitioner's side, De Qi is felt as a "catching" under the needle — "like a fish taking the hook." TCM considers it the prerequisite for therapeutic effect. fMRI studies show distinct limbic deactivation in subjects reporting De Qi versus those who do not, correlating with connective-tissue deformation and mechanoreceptor activation at the needling site.

Once De Qi arrives, manipulation determines whether the point is **tonified** (_bǔ_, 補) or **drained** (_xiè_, 瀉): tonifying uses insertion with channel flow, slow insertion / rapid withdrawal, small-amplitude rotation, longer retention, and hole closure after removal; draining reverses each parameter. The two primary techniques are **lifting and thrusting** (_tí chā_, 提插) — rhythmic vertical movement that amplifies De Qi and directs Qi along the channel — and **twirling** (_niǎn zhuǎn_, 捻轉) — rotational movement, large amplitude for draining, small for tonifying. An **even technique** is used where no clear excess or deficiency is present. Retention is typically 20–30 minutes. **Warming needle** (_wēn zhēn_, 溫針) — moxa cone attached to the needle handle — bridges needling and moxibustion.
...
**Contraindications:** Heat patterns, [Liu Yin](LiuYin.md) Wind-Heat invasion, full-Heat patterns, Yin-deficiency Empty Heat, and fever — moxa aggravates all. Pregnancy-forbidden points (see Safety). Head and face points in sensitive patients (poor healing, scarring risk). Areas of skin breakdown, infection, or impaired sensation.
...
```mermaid
flowchart TD
    A["Si Zhen — Four Examinations\n(Looking, Listening, Asking, Palpating)"] --> B["Ba Gang — Eight Principle pattern\n(Yin/Yang, Interior/Exterior,\nCold/Heat, Deficiency/Excess)"]
    B --> C["Zang-Fu organ pattern\n(Which organ system is affected?)"]
    C --> D["Channel selection\n(Primary channels, extraordinary vessels,\nluo-connecting, divergent)"]
    D --> E["Point selection\n(Local + distal; categorical points;\nspecific protocol points)"]
    E --> F["Manipulation\n(Tonify vs Drain; needle vs moxa;\nretention time)"]
```
...
**Five-Element acupuncture (J.R. Worsley lineage).** Developed in the UK by J.R. Worsley (1923–2003). Prioritizes the causative factor (CF) — the constitutional element (Fire, Earth, Metal, Water, or Wood via [WuXing.md](WuXing.md)) underlying all the patient's presentations. Treatment uses five-shu points almost exclusively; fewer needles per treatment, often unilateral, with strong practitioner-patient focus.
...
**Electroacupuncture (EA).** Electrical stimulus delivered through retained needle handles. Low frequency (2–4 Hz) preferentially releases enkephalins and beta-endorphins; high frequency (80–100 Hz) releases dynorphins — a frequency-dependent opioid mechanism confirmed in animal models. The most thoroughly studied stimulation form; used in pain management, chemotherapy-induced nausea (PC 6), and post-stroke rehabilitation.
...
The Acupuncture Trialists' Collaboration individual patient data meta-analysis (2018, >17,000 patients, >20 trials) found acupuncture significantly superior to sham and no-treatment for **chronic low back pain**, neck pain, shoulder pain, and **chronic headache/migraine prevention** — effect sizes roughly equivalent to NSAIDs, durable at 12-month follow-up.
...
**Headache prevention:** the 2022 Cochrane update found acupuncture at least as effective as prophylactic drugs for episodic migraine and tension-type headache, with a better adverse-event profile — the clearest cost-effectiveness case in Western healthcare.
...
Sham controls (Streitberger retractable needles, non-acupoint shallow needling, non-specific-site penetrating needles) frequently outperform inert controls — sometimes nearly matching "real" acupuncture. Two interpretations: (1) **skeptical** — acupuncture is a sophisticated placebo; context is the active ingredient. (2) **physiological** — needling anywhere activates overlapping mechanisms (gate control, connective-tissue signaling, endorphin release); acupoint vs. non-acupoint is continuous, not binary; sham is active low-dose, not inert. Both are consistent with current data. The critical point: sham-controlled trials still find acupuncture superior to no treatment across the best-supported indications.
...
**Serious adverse events (rare but documented):** _Pneumothorax_ — puncture of the lung through thoracic points (LU 1, LU 2, BL 13 too deep, GB 21 angled incorrectly); the most serious preventable adverse event; avoided by correct depth limits and angling. _Infection_ — eliminated by single-use disposable needle protocol; shared needle reuse historically transmitted hepatitis B and C. _Broken needles_ — prevented by quality single-use needles and never forcing against resistance; do not forcibly remove a stuck needle, relax surrounding tissue first. _Cardiac tamponade_ — extremely rare; CV 17 or nearby precordial points needled too deeply in patients with pericardial effusion or post cardiac surgery.
...
**Anticoagulants and bleeding disorders:** warfarin, heparin, direct oral anticoagulants, and known bleeding disorders require modified technique — avoid points over major vessels, minimize needle count, monitor for prolonged bleeding. Not an absolute contraindication but requires clinical judgment.
...
By comparison with pharmacological pain treatments — NSAIDs carry 1–2% annual GI bleed risk; opioids carry addiction, overdose, and constipation burden — acupuncture's risk profile is favorable for appropriate indications.
