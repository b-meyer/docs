---
title: 'Yin & Yang (Dao)'
description: "The foundational dualism of TCM — how Yin and Yang articulate the Dao, organize the body's physiology, and ground every diagnosis and treatment."
---
...
The familiar swirling circle — black and white, each curving into the other — is called the _Taijitu_ ("diagram of the supreme ultimate"). Formalized during the Song Dynasty by the philosopher Zhou Dunyi (1017–1073 CE), it encodes several ideas at once:

- **Opposition.** The two halves are maximally different — Yin dark/receptive/descending, Yang light/active/ascending. The S-curve dividing line encodes gradual transition: winter does not snap into summer, fever does not snap into health.
- **Interpenetration.** Each half holds a small circle of the opposite color. Pure absolute Yin or Yang does not exist — every Yang organ contains a Yin seed, every Yin fluid the potential for Yang activation. This is the most clinically significant element.
...
The clinical payoff is at the organ level. The Kidney is a Yin organ (solid, storing, deep — [ZangFu.md](ZangFu.md)), yet within it TCM distinguishes **Kidney Yin** (moist, cooling stored substance; root of all Yin in the body) from **Kidney Yang** (the warming vital flame housed in the same organ; root of all Yang — also called Ming Men). These can fail independently: Kidney Yin deficiency produces empty-heat (night sweats, five-palm heat); Kidney Yang deficiency produces empty-cold (cold limbs, exhaustion, weak lower back). Long-standing deficiency of one drags down the other — the Neijing calls this "Yin damage reaching Yang." For Kidney as Jing storehouse, see [Jing.md](Jing.md); for Yin-Yang as the scaffold for Five Phases, see [WuXing.md](WuXing.md).
...
- **Yin** represents substance, structure, and cooling — blood, body fluids, tissues, and the physical architecture of the organs. It anchors, moistens, and cools.
- **Yang** represents energy, function, and warming — Qi (vital energy), metabolic heat, circulation, and the physiological work the organs perform. It transforms, warms, and activates.
...
Yin and Yang are the **summary pair** of the Eight Principles (Ba Gang) — the foundational diagnostic framework that classifies all patterns along four axes: Yin/Yang, Interior/Exterior, Cold/Heat, Excess/Deficiency. Every substance disharmony and organ pattern ultimately resolves to a Yin or Yang imbalance, which is why the Eight Principles begin and end with this pair. See [BaGang.md](BaGang.md) for the full framework; the clinical significance appears throughout the substance pages that follow.
...
A TCM practitioner's primary diagnostic goal is to determine where the Yin-Yang balance has defaulted, using the Four Diagnostic Methods — looking, listening/smelling, asking, and touching (especially tongue inspection and radial pulse reading).

Once the imbalance is identified, the treatment strategy is to reduce the excess or tonify (replenish) the deficiency:

- **For Yang excess** — Cooling herbs (e.g., Huang Lian) and acupuncture points to "clear heat."
...
- **Sympathetic vs parasympathetic** _(tight, with a caveat)._ Sympathetic activation maps to Yang, parasympathetic to Yin. Modern physiology has abandoned strict reciprocal control — many reflexes co-activate both branches — but the Taijitu's dots already encode this nuance.
