...
<template>
  <div class="flex items-center">
    <a
      ...
      class="inline-flex size-10 items-center justify-center rounded text-gray-700 hover:bg-primary-50 dark:text-gray-400 dark:hover:bg-gray-175 dark:hover:text-gray-100"
    >
