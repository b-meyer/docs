 ...
 * theme inputs (the `.dark` class, `--brand-hue`, `--brand-intensity`) change. Debounced so
 * a slider drag triggers one re-render on release, not one per pointer move. Returns a
 * disposer.
 */
